...
CalculateSum	proc
		...
		; The reason a subtraction is made instead of adding is because the x86 stack grows downwards, towards lower memory addresses. 
		...
		mov ebp, esp ; Set the new base pointer to the current top of the stack
		sub esp, 12 ; Allocate 12 bytes for variables in local storage space.
		push ebx
		push esi
		push edi
